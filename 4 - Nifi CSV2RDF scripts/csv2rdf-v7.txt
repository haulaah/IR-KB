            ...
            try {
                ...
                if (tasksJson) {
                    try {
                        ...
                        tasks.each { task ->
                            ...
                            def taskUri = "<http://irkb.com/ir-ontology/courseofaction/${incidentId}_${coaCategory.toLowerCase()}_${count}>"
                            coaLinks << taskUri
                        }
                    } catch (ex) {
                ...
                if (observablesJson) {
                    try {
                        ...
                        observables.each { obs ->
                            def obsUri = "<http://irkb.com/ir-ontology/artefact/${incidentId}_artefact_${artefactCounter}>"
                            artefactCounter++
                ...
                if (analysisJson) {
                    try {
                        ...
                        analysisList.each {
                            def analysisUri = "<http://irkb.com/ir-ontology/securityanalysis/${incidentId}_analysis_${analysisCounter}>"
                            analysisCounter++
